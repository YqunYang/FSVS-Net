...
class FeatureFusionBlock(nn.Module):
    def __init__(self, indim, outdim):
        ...
        self.attention = SIE_modules.CBAM(outdim)
...
class ValueEncoderSO(nn.Module):
    def __init__(self):
        ...
        resnet = SIE_modules.resnet18(pretrained=False, extra_chan=1)
